...
function ConfToIndex(conf, hts_state)
  ...
  return ( Int(floor(( (conf[1]-hts_state.originCoordinates[1])/hts_state.cellRes))), Int(floor(((conf[2]-hts_state.originCoordinates[2])/hts_state.cellRes))), Int(floor((hdng/hts_state.hdngRes))) )
